...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(turtle_bot_gazebo_dir, 'worlds', 'turtle_world.world'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join(turtle_bot_exploration_dir, 'config', 'exploration.rviz'),
    ...
    # Enhanced Exploration Coordinator with all optimizations
        ...
        parameters=[
            {
                ...
                'recovery_rotation_speed': 0.6,
                'recovery_rotation_duration': 4.0,
                # Frontier selection optimization
    ...
    # Emergency Stop Controller - Temporarily disabled until implementation is complete
    ...
    # RViz with exploration visualization
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
    ...
    # ld.add_action(emergency_stop_node)  # Temporarily disabled
